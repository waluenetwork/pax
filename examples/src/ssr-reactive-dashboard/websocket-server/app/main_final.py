    ...
    try:
        ...
        while True:
            ...
            if message_count % 5 == 0:
                ...
                print(f"📨 Sending FIXED template message #{message_count}")
...
def generate_dynamic_template(count: int) -> str:
    """Generate dynamic Pax template with PROPER syntax and ID selectors"""
...
@app.get("/")
async def root():
    return {"message": "SSR WebSocket Server for Pax Dashboard - FINAL FIXED VERSION"}
