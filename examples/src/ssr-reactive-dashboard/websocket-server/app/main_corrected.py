    ...
    try:
        ...
        while True:
            ...
            if message_count % 5 == 0:
                ...
                print(f"📨 Sending template message #{message_count}: {template_content[:100]}...")
...
def generate_dynamic_template(count: int) -> str:
    """Generate dynamic Pax template based on count with proper syntax"""
...
@app.get("/")
async def root():
    return {"message": "SSR WebSocket Server for Pax Dashboard - Corrected Version"}
