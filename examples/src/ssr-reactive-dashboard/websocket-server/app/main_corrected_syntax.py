    ...
    try:
        ...
        while True:
            ...
            if message_count % 5 == 0:
                ...
                print(f"📨 Sending SYNTAX CORRECTED template message #{message_count}")
...
def generate_dynamic_template(count: int) -> str:
    """Generate dynamic Pax template with CORRECTED SYNTAX and proper ID selectors"""
...
@app.get("/")
async def root():
    return {"message": "SSR WebSocket Server for Pax Dashboard - SYNTAX CORRECTED VERSION"}
