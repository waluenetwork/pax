    ...
    try:
        ...
        while True:
            ...
            if message_count % 5 == 0:
                ...
                print(f"📨 Sending TEMPLATE FIXED message #{message_count}")
...
def generate_dynamic_template(count: int) -> str:
    """Generate dynamic Pax template with EXACT WORKING SYNTAX from client template"""
...
@app.get("/")
async def root():
    return {"message": "SSR WebSocket Server for Pax Dashboard - TEMPLATE FIXED VERSION"}
